/*
  ...
  - You are about to drop the column `passengers` on the `Trip` table. All the data in the column will be lost.
...
INSERT INTO "new_Trip" ("approvedById", "assignedById", "company", "createdAt", "department", "driverId", "driverName", "endMileage", "entitledVehicleId", "fromLoc", "fromTime", "id", "personalVehicleDetails", "purpose", "rejectionReason", "requesterId", "startMileage", "status", "stops", "toLoc", "toTime", "updatedAt", "vehicleCategory", "vehicleId", "vehicleNumber") SELECT "approvedById", "assignedById", "company", "createdAt", "department", "driverId", "driverName", "endMileage", "entitledVehicleId", "fromLoc", "fromTime", "id", "personalVehicleDetails", "purpose", "rejectionReason", "requesterId", "startMileage", "status", "stops", "toLoc", "toTime", "updatedAt", "vehicleCategory", "vehicleId", "vehicleNumber" FROM "Trip";
DROP TABLE "Trip";
